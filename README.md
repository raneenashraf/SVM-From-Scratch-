...
🔬 Usage Guide
Upload Dataset: In the left sidebar, upload a .csv or .xlsx file (or leave empty to use the default synthetic classification dataset). Select the target column.
Visualize Features: Explore feature relationships and class separations in Tab 2.
Train Linear SVMs:
...
### Summary of Work
- Analyzed the full SVM project structure, including the Streamlit apps (`svm_app.py`, `fsvm_app.py`, `hingeloss_app.py`, `rbd_app.py`), mathematical formulations, team info, and optimization solvers.
- Generated and wrote [`README.md`](file:///e:/RANEEN/Projects/convex/SVM/README.md) containing project architecture, mathematical formulations (QP primal/dual, gradient/subgradient descent, RBF/Poly kernels), usage instructions, and repository structure.
