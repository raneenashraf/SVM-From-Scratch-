...
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
    with tab4:
        ...
        model_sources = {
            ...
            'Sigmoid Kernel SVM': getattr(st.session_state, 'sigmoid_model', None)
        }
        ...
        if model_type == "Hard Margin SVM":
            ...
            **Hard Margin SVM Characteristics:**
            ...
            elif model_type == "Sigmoid Kernel SVM":
                with param_col1:
                    C = st.slider("Regularization (C)", 0.01, 10.0, 1.0)
                    gamma = st.slider("Gamma (γ)", 0.001, 1.0, 0.1)
                with param_col2:
                    coef0 = st.slider("Coefficient (r)", -1.0, 1.0, 0.0)
            ...
            with st.spinner(f"Training {model_type}..."):
                try:
                    if model_type == "Hard Margin SVM":
                        ...
                        model = KernelSVM(kernel='sigmoid', C=C, gamma=gamma, coef0=coef0)
    ...
    with tab5:
        ...
        try:
           with open(r"C:\Users\ranee\Dropbox\PC\Desktop\SVM\project_convex_kernel_analysis .html", 'r', encoding='utf-8') as file:
